...
const ds = StyleSheet.create({
  ...
  resultTitle: { fontSize: 28, fontFamily: 'Figtree_700Bold', color: '#0F172A', marginBottom: 2 },
  resultSub: { fontSize: 15, fontFamily: 'Figtree_600SemiBold', color: '#64748B', marginBottom: 16 },
  notesCard: {
  ...
  sectionLabel: { fontSize: 12, fontFamily: 'Figtree_700Bold', color: '#94A3B8', letterSpacing: 1.2, textTransform: 'uppercase' },
  editBtn: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  editBtnText: { fontSize: 13, fontFamily: 'Figtree_700Bold', color: '#2563EB' },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip: { backgroundColor: '#EFF6FF', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20 },
  chipText: { fontSize: 15, fontFamily: 'Figtree_600SemiBold', color: '#2563EB' },
  diagBox: { backgroundColor: '#EFF6FF', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14 },
  diagText: { fontSize: 18, fontFamily: 'Figtree_700Bold', color: '#1E293B', lineHeight: 26 },
  bulletRow: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 10 },
  bullet: { width: 7, height: 7, borderRadius: 999, backgroundColor: '#2563EB', marginTop: 7, marginRight: 10 },
  bulletText: { flex: 1, fontSize: 17, fontFamily: 'Figtree_600SemiBold', color: '#0F172A', lineHeight: 24 },
  emptyText: { fontSize: 14, fontFamily: 'Figtree_600SemiBold', color: '#CBD5E1' },
  editInput: {
  ...
  addBtnText: { fontSize: 14, fontFamily: 'Figtree_700Bold', color: '#2563EB' },
